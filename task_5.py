...
# Example mock packets for testing
mock_tcp_packet = IP(src="192.168.0.1", dst="192.168.0.2")/TCP()/b"TCP Payload"
mock_udp_packet = IP(src="192.168.0.1", dst="192.168.0.2")/UDP()/b"UDP Payload"
mock_icmp_packet = IP(src="192.168.0.1", dst="192.168.0.2")/ICMP()/b"ICMP Payload"
